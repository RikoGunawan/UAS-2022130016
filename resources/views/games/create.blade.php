                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('games.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="size_mb" type="number" class="form-control @error('size_mb') is-invalid @enderror" name="size_mb" value="{{ old('size_mb') }}" required autocomplete="size_mb">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="image_path" type="text" class="form-control @error('image_path') is-invalid @enderror" name="image_path" value="{{ old('image_path') }}" autocomplete="image_path">
